...
const FeatureCard = (item) => {
  return (
    <Col
      ...
      sm="6"
      md="3"
      className="feature-card d-flex flex-row justify-content-start justify-content-md-center mb-1 p-3 ps-0 pe-0 "
    >
      <div className="p-2 ps-md-3 pe-md-5 align-self-center">
